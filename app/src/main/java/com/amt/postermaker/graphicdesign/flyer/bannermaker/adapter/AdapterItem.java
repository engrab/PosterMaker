...
public class AdapterItem extends DragItemAdapter<Pair<Long, View>, AdapterItem.ViewHolder> {
    Activity activity;
    ...
    class ViewHolder extends DragItemAdapter.ViewHolder {
        ...
        ViewHolder(View view) {
            super(view, AdapterItem.this.mGrabHandleId, AdapterItem.this.mDragOnLongPress);
    ...
    public AdapterItem(Activity activity2, ArrayList<Pair<Long, View>> arrayList, int i, int i2, boolean z) {
        this.mLayoutId = i;
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, int i) {
        ...
        viewHolder.img_lock.setOnClickListener(new OnClickListener() {
            public void onClick(View view2)
            {
                ...
                ((PosterActivity) AdapterItem.this.activity).listFragment.getLayoutChild(false);
