...
import com.amt.postermaker.graphicdesign.flyer.bannermaker.adapter.AdapterHorizontalListView;
import com.amt.postermaker.graphicdesign.flyer.bannermaker.adapter.AdapterImageSd;
...
public class CreateFrameActivity extends Activity {
    ...
    private AdapterSticker _adapter;
    ...
    AdapterImageSd imageListAdapter;
    private RelativeLayout image_list_container;
    AdapterHorizontalListView images_listview;
