...
public class Main {
    public static final int[] MaterialTabHost = new int[]{R.attr.hasIcons, R.attr.primaryColor, R.attr.accentColor, R.attr.iconColor, R.attr.textColor};
