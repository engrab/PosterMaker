...
public enum Edge {
    ...
    public void adjustCoordinate(float aspectRatio) {
        ...
        switch (this) {
            case LEFT:
                this.mCoordinate = ClassAspectRatioUtil.calculateLeft(top, right, bottom, aspectRatio);
                return;
            case TOP:
                this.mCoordinate = ClassAspectRatioUtil.calculateTop(left, right, bottom, aspectRatio);
                return;
            case RIGHT:
                this.mCoordinate = ClassAspectRatioUtil.calculateRight(left, top, bottom, aspectRatio);
                return;
            case BOTTOM:
                this.mCoordinate = ClassAspectRatioUtil.calculateBottom(left, top, right, aspectRatio);
                return;
            default:
                return;
        }
        ...
        switch (this) {
            case LEFT:
                if (edge.equals(TOP)) {
                    ...
                    return isOutOfBounds(top, ClassAspectRatioUtil.calculateLeft(top, right, bottom, aspectRatio), bottom, right, imageRect);
            ...
            case TOP:
                if (edge.equals(LEFT)) {
                    ...
                    return isOutOfBounds(ClassAspectRatioUtil.calculateTop(left, right, bottom, aspectRatio), left, bottom, right, imageRect);
            ...
            case RIGHT:
                if (edge.equals(TOP)) {
                    ...
                    return isOutOfBounds(top, left, bottom, ClassAspectRatioUtil.calculateRight(left, top, bottom, aspectRatio), imageRect);
                } else if (edge.equals(BOTTOM)) {
                    bottom = (float) imageRect.bottom;
                    top = TOP.getCoordinate() - offset;
                    left = LEFT.getCoordinate();
            ...
            case BOTTOM:
                if (edge.equals(LEFT)) {
                    ...
                    return isOutOfBounds(top, left, ClassAspectRatioUtil.calculateBottom(left, top, right, aspectRatio), right, imageRect);
                } else if (edge.equals(RIGHT)) {
                    right = (float) imageRect.right;
                    left = LEFT.getCoordinate() - offset;
                    top = TOP.getCoordinate();
