...
public class CropOverlayView extends View {
    ...
    private static final float DEFAULT_CORNER_OFFSET_DP = ((PaintUtil.getCornerThickness() / 2.0f) - (PaintUtil.getLineThickness() / 2.0f));
    ...
    private static final float DEFAULT_CORNER_EXTENSION_DP = ((PaintUtil.getCornerThickness() / 2.0f) + DEFAULT_CORNER_OFFSET_DP);
    ...
    private void initCropWindow(Rect bitmapRect) {
        ...
        if (!this.mFixAspectRatio) {
        ...
        } else if (ClassAspectRatioUtil.calculateAspectRatio(bitmapRect) > this.mTargetAspectRatio) {
            ...
            float cropWidth = Math.max(40.0f, ClassAspectRatioUtil.calculateWidth(Edge.TOP.getCoordinate(), Edge.BOTTOM.getCoordinate(), this.mTargetAspectRatio));
            if (cropWidth == 40.0f) {
            ...
            float cropHeight = Math.max(40.0f, ClassAspectRatioUtil.calculateHeight(Edge.LEFT.getCoordinate(), Edge.RIGHT.getCoordinate(), this.mTargetAspectRatio));
            if (cropHeight == 40.0f) {
