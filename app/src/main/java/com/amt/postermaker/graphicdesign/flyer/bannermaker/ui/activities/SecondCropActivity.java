...
import com.amt.postermaker.graphicdesign.flyer.bannermaker.gotoCrop.ImageCrope;
...
public class SecondCropActivity extends Activity {
    public static Bitmap bitmapImage;
    Bitmap bitmap;
    Animation bottomDown;
    Animation bottomUp;
    ImageCrope cropimage;
    Button custom;
    ImageView done;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.cropimage = findViewById(R.id.cropimage);
        this.done =  findViewById(R.id.done);
        this.custom = findViewById(R.id.cutom);
        this.square = findViewById(R.id.square);
        this.ratio1 = findViewById(R.id.ratio1);
        this.ratio2 = findViewById(R.id.ratio2);
        this.ratio3 = findViewById(R.id.ratio3);
        this.ratio4 = findViewById(R.id.ratio4);
        this.ratio5 = findViewById(R.id.ratio5);
        this.ratio6 = findViewById(R.id.ratio6);
        this.ratio7 = findViewById(R.id.ratio7);
        this.ratio8 = findViewById(R.id.ratio8);
        this.ratio9 = findViewById(R.id.ratio9);
        this.ratio10 = findViewById(R.id.ratio10);
        this.ratio11 = findViewById(R.id.ratio11);
        this.ratio12 = findViewById(R.id.ratio12);
        this.ratio13 = findViewById(R.id.ratio13);
        this.ratio14 = findViewById(R.id.ratio14);
        this.ratio15 = findViewById(R.id.ratio15);
        ...
        findViewById(R.id.btn_bck).setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                SecondCropActivity.this.finish();
            }
        });
        ...
        this.done.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                SecondCropActivity.this.bitmap = SecondCropActivity.this.cropimage.getCroppedImage();
                if (SecondCropActivity.this.value.equals("image")) {
                    SecondCropActivity.bitmapImage = SecondCropActivity.this.bitmap;
                    SecondCropActivity.this.setResult(-1);
                    SecondCropActivity.this.finish();
                    return;
                }
                SecondCropActivity.this.bitmap = ImageUtils.resizeBitmap(SecondCropActivity.this.bitmap, (int) SecondCropActivity.this.screenWidth, (int) SecondCropActivity.this.screenHeight);
                SecondCropActivity.bitmapImage = SecondCropActivity.this.bitmap;
                SecondCropActivity.this.getSticker.ongetSticker();
                SecondCropActivity.this.finish();
        ...
        this.custom.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                SecondCropActivity.this.cropimage.setFixedAspectRatio(false);
            }
        });
        ...
        this.square.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                SecondCropActivity.this.cropimage.setFixedAspectRatio(true);
                SecondCropActivity.this.cropimage.setAspectRatio(1, 1);
            }
        });
        ...
        this.ratio1.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                SecondCropActivity.this.cropimage.setFixedAspectRatio(true);
                SecondCropActivity.this.cropimage.setAspectRatio(1, 2);
            }
        });
        ...
        this.ratio2.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                SecondCropActivity.this.cropimage.setFixedAspectRatio(true);
                SecondCropActivity.this.cropimage.setAspectRatio(2, 1);
            }
        });
        ...
        this.ratio3.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                SecondCropActivity.this.cropimage.setFixedAspectRatio(true);
                SecondCropActivity.this.cropimage.setAspectRatio(2, 3);
            }
        });
        ...
        this.ratio4.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                SecondCropActivity.this.cropimage.setFixedAspectRatio(true);
                SecondCropActivity.this.cropimage.setAspectRatio(3, 2);
            }
        });
        ...
        this.ratio5.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                SecondCropActivity.this.cropimage.setFixedAspectRatio(true);
                SecondCropActivity.this.cropimage.setAspectRatio(3, 4);
            }
        });
        ...
        this.ratio6.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                SecondCropActivity.this.cropimage.setFixedAspectRatio(true);
                SecondCropActivity.this.cropimage.setAspectRatio(3, 5);
            }
        });
        ...
        this.ratio7.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                SecondCropActivity.this.cropimage.setFixedAspectRatio(true);
                SecondCropActivity.this.cropimage.setAspectRatio(4, 3);
            }
        });
        ...
        this.ratio8.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                SecondCropActivity.this.cropimage.setFixedAspectRatio(true);
                SecondCropActivity.this.cropimage.setAspectRatio(4, 5);
            }
        });
        ...
        this.ratio9.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                SecondCropActivity.this.cropimage.setFixedAspectRatio(true);
                SecondCropActivity.this.cropimage.setAspectRatio(4, 7);
            }
        });
        ...
        this.ratio10.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                SecondCropActivity.this.cropimage.setFixedAspectRatio(true);
                SecondCropActivity.this.cropimage.setAspectRatio(5, 3);
            }
        });
        ...
        this.ratio11.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                SecondCropActivity.this.cropimage.setFixedAspectRatio(true);
                SecondCropActivity.this.cropimage.setAspectRatio(5, 6);
            }
        });
        ...
        this.ratio12.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                SecondCropActivity.this.cropimage.setFixedAspectRatio(true);
                SecondCropActivity.this.cropimage.setAspectRatio(5, 4);
            }
        });
        ...
        this.ratio13.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                SecondCropActivity.this.cropimage.setFixedAspectRatio(true);
                SecondCropActivity.this.cropimage.setAspectRatio(5, 7);
            }
        });
        ...
        this.ratio14.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                SecondCropActivity.this.cropimage.setFixedAspectRatio(true);
                SecondCropActivity.this.cropimage.setAspectRatio(9, 16);
            }
        });
        this.ratio15.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                SecondCropActivity.this.cropimage.setFixedAspectRatio(true);
                SecondCropActivity.this.cropimage.setAspectRatio(16, 9);
            }
        });
    }
