...
public class GridAdapter extends ArrayAdapter<StickerInfo> {
    ...
    class ViewHolder {
        ...
        class C05831 implements View.OnClickListener {
            C05831() {
            }
        ...
        class C05842 implements View.OnClickListener {
            C05842() {
            }

            public void onClick(View v) {
                Log.i("testing", "Downloaded " + ViewHolder.this.stickerInfo.getIMAGE_PATH());
                Toast.makeText(GridAdapter.this.context, GridAdapter.this.context.getResources().getString(R.string.deleted), Toast.LENGTH_SHORT).show();
                DatabaseHandler dbHanlder = DatabaseHandler.getDbHandler(GridAdapter.this.context);
        ...
        public void refreshImage() {
            ...
            if (this.stickerInfo.isIS_DOWNLOADING()) {
                ...
                this.download.setOnClickListener(new C05831());
            } else {
                ...
                this.download.setOnClickListener(new C05842());
            }
        }
