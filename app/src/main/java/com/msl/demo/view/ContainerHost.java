...
import com.msl.demo.LibContants;
import com.msl.demo.StickerInfo;
...
public class ContainerHost extends RelativeLayout {
    ...
    class C05901 implements android.widget.AdapterView.OnItemClickListener {
        C05901() {
        }
    ...
    public void initContainerHost(Context context) {
        ...
        this.horizontalListView.setOnItemClickListener(new C05901());
    }
